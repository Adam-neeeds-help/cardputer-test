...
Rectangle {
    ...
    gradient: Gradient {
        GradientStop { position: 0; color: Theme.shade(1.0, 0.02) }
        GradientStop { position: 1; color: Theme.shade(1.0, 0.075) }
    }
    ...
    Canvas {
        ...
        // Repaint when the theme accent changes so the grid follows it.
        property color gridColor: Theme.shade(0.78, 0.375)
        ...
        onPaint: {
            ...
            ctx.strokeStyle = gridCanvas.gridColor;
            ctx.lineWidth = 2;
